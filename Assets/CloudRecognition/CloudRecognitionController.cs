...
public class CloudRecognitionController : MonoBehaviour, ICloudRecoEventHandler
{
    ...
    private void fillFriends()
    {
        ...
        if (json_def.HasField("value0")) StartCoroutine(cargaImagen(json.GetField("value0").GetField("1").str, this.transform.Find("Canvas/FirstPosition").GetComponent<UnityEngine.UI.Image>()));
